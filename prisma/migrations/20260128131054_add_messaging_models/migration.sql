...
-- CreateIndex
CREATE INDEX "Conversation_buildingId_idx" ON "Conversation"("buildingId");
...
-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_buildingId_fkey" FOREIGN KEY ("buildingId") REFERENCES "Building"("id") ON DELETE CASCADE ON UPDATE CASCADE;
